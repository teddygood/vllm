    ...
    def forward_impl(
        ...
        with sp_ctx:
            ...
            if do_naive_dispatch_combine:
                hidden_states_dispatch, router_logits = get_ep_group().dispatch(
            ...
            if self.pcp_size > 1:
                hidden_states_dispatch = get_pcp_group().all_gather(
                    hidden_states_dispatch,
                    dim=0,
                )
